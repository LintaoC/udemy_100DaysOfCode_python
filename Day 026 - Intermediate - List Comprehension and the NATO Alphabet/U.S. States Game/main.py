...
while len(guessed_state) < 50:
    ...
    if answer_state.title() == "Exit":
        ...
        # Improvement from day 026, for loop is replaced by a conditional list comprehension
        state_to_learn_list = [states for states in states_data_list if states not in guessed_state]
